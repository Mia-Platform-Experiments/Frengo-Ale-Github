# Frengo Ale Github Configurations

This repository contains all the configuration resources required for the Frengo Ale Github project to function properly and expose its business features.
